...
#Αν κανείς δεν έχει βαθμολογήσει την ταινία θεωρούμε ότι δεν έχει βαθμολογηθεί ούτε
#αρνητικα <2.5 όυτε θετικά >2.5 και δίνουμε την τιμή 2.5
...
#ψαχνει τις "num" πρώτες πιο συναφείς ταινίες απο την elastic search
#Στη συνέχεια για κάθε ταινία χρησιμοποιεί τις προηγούμενες συναρτήσεις
#για να πάρει τον μέσο όρο των βαθμολογιών και την βαθμολογία του χρήστη αν αυτή υπάρχει
#Τέλος χρησιμοποιεί την calculate_score για να πάρει τα αποτελέσματα απο την εφαρμογ΄ή
#της δικής μας μετρικής και σορτάρει τις ταινίες ανάλογα με αυτη.
